...
public class Const {
    ...
    public final static String INTENT_BLE_OPERATE_STARTED = "air.SmartLog.android.ble.INTENT_BLE_OPERATE_STARTED";
    public final static String INTENT_BLE_OPERATE_COMPLETED = "air.SmartLog.android.ble.INTENT_BLE_OPERATE_COMPLETED";
    ...
    public final static String INTENT_BLE_READ_AFTER = "air.SmartLog.android.ble.INTENT_BLE_READ_AFTER";
    public final static String INTENT_BLE_READ_LAST = "air.SmartLog.android.ble.INTENT_BLE_READ_LAST";
    ...
    public final static String INTENT_BLE_RACP_INDICATION_ENABLED = "air.SmartLog.android.ble.INTENT_BLE_RACP_INDICATION_ENABLED";
    public final static String INTENT_BLE_SEQUENCE_COMPLETED = "air.SmartLog.android.ble.BLE_SEQUENCECOMPLETED";
    ...
    public final static String INTENT_STOP_SCAN = "com.isens.standard.ble.INTENT_STOP_SCAN";
     ...
     public final static String INTENT_BLE_DATASET_CHANGED = "air.SmartLog.android.ble.BLE_DATASETCHANGED";
