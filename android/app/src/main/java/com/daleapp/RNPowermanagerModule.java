...
public class RNPowermanagerModule extends ReactContextBaseJavaModule {
    ...
    public void isIgnoringBatteryOptimizations(Promise promise) {
        // for lock cpu for background service added by rihyokju 20191010
        /*
         * PowerManager powerManager = (PowerManager) getSystemService(POWER_SERVICE);
         * PowerManager.WakeLock wakeLock =
         * powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK,
         * "MyWakelockTagForLockCPU"); if (wakeLock != null) { //Log.w("RHJ",
         * "wakeLock acquire"); //wakeLock.acquire(); } else { Log.w("RHJ",
         * "failed to new WakeLock");
         * 
         * }
         */
        // wakeLock.release();
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            PowerManager pm = (PowerManager) this.reactContext.getSystemService(POWER_SERVICE);
            if (pm != null) {
    ...
    public void setIgnoringBatteryOptimizations() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            Intent intent = new Intent(); String packageName = reactContext.getPackageName();
            PowerManager pm = (PowerManager) this.reactContext.getSystemService(POWER_SERVICE);
            if
