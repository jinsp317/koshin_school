...
export const PATTERN_CARD_NUMBER: RegExp = /\d{18}/;
...
export const PATTERN_DATE: RegExp = /\d{8}/;
// export const PATTERN_DATE: RegExp = /\d{2}\/\d{2}\/\d{4}/;

export const AccountValidator = (value: string): boolean => {
  return true;
};
...
export const DateValidator = (value: string): boolean => {
  return RegExpValidator(PATTERN_DATE, value);
};
