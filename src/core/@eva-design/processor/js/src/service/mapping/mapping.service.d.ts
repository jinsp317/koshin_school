import { ThemeMappingType, ControlMappingType, MappingType } from '@eva-design/dss';
...
export declare function getStateAppearanceMapping(mapping: ThemeMappingType, component: string, appearance: string, state: string): MappingType | undefined;
export declare function getStatelessAppearanceMapping(mapping: ThemeMappingType, component: string, appearance: string): MappingType | undefined;
...
export declare function getStatelessVariantMapping(mapping: ThemeMappingType, component: string, appearance: string, variant: string): MappingType | undefined;
