...
import { ConsultModel, RequestConsultModel, PatientModel } from "@src/core/model";
import { ConsultLog } from "./consultLog.component";
...
class ConsultLogScreen extends React.Component<Props, State> {
  private _seedInfo: PatientModel;
  private _endDate: Date;
  private _reqParam: RequestConsultModel;
  ...
  private updateDataPromise = (kind: UpdateKind): Promise<ConsultModel[]> => {
    const that = this;
    ...
    return new Promise(function (resolve, reject) {
      database.consultRecordHelper.downloadConsults(reqParam)
        .then(responseJson => {
  ...
  private onItemSelect = (item: ConsultModel) => { };
  render() {
...
export const ConsultLogContainer = withStyles(ConsultLogScreen, (theme: ThemeType) => ({
  container: {
    flex: 1,
