...
import { PatientModel, InhospitalModel, ConsultModel } from "@src/core/model";
...
interface ComponentProps {
  ...
  data: ConsultModel[];
  onItemSelect: (item: ConsultModel) => void;
...
class MyComponent extends React.Component<Props, State> {
  ...
  private onItemPress = (item: ConsultModel) => {
  ...
  private renderHeader = () => {
    ...
    return (
      <View style={themedStyle.header}>
        {GLOBAL.HEADERITEMS_CONSULTS.map((item, idx) => {
          const flexValue = 1;
          const colW = idx == 2 || idx == 3 ? 120 : 100;
          return (
...
export const ConsultLog = withStyles(MyComponent, (theme: ThemeType) => ({
  container: {
    flex: 1
  },
  contentContainer: {
