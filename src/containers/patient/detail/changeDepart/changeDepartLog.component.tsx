          ...
          <Text style={commonStyles.toolbarText}>
            {this.props.seedInfo &&
              `${GLOBAL.curPatient.name} (${
                this.props.seedInfo.in_date
                  ? this.props.seedInfo.in_date.substr(0, 10)
                  : ""
              } ~ ${
                this.props.seedInfo.out_date
                  ? this.props.seedInfo.out_date.substr(0, 10)
                  : ""
              })`}
          </Text>
        </View>
  ...
  private renderHeader = () => {
    ...
    return (
      <View style={themedStyle.header}>
        {GLOBAL.HEADERITEMS_CHANGEDEPARTS.map((item, idx) => {
          const flexValue = 1;
          const colW = idx == 1 || idx == 4 ? 100 : 80;
          return (
...
export const ChangeDepartLog = withStyles(MyComponent, (theme: ThemeType) => ({
  container: {
    flex: 1
  },
  contentContainer: {
