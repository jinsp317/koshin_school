    ...
    return (
      <View style={themedStyle.container}>
        ...
        <View style={{ paddingTop: 5 }}>
          <Button
            style={{ marginVertical: 2, borderRadius: 3, borderWidth: 0.5 }}
            icon={PersonIconFill}
            size="giant"
            onPress={() => this.props.onItemPress(0)}
          >
            {this.props.isYuannei
              ? Strings.patient.faqihuizhen
              : Strings.patient.faqisuifang}
          </Button>

          <Button
            style={{ margin: 2, borderRadius: 3 }}
            icon={this.props.isYuannei ? LoginIconOutline : LoginoutOutline}
            size="giant"
            onPress={() => this.props.onItemPress(1)}
          >
            {this.props.isYuannei
              ? Strings.patient.banlichuyuan
              : Strings.patient.banliruyuan}
          </Button>
          <Button
            style={{ margin: 2, borderRadius: 3 }}
          ...
          >
            {this.props.isYuannei
              ? Strings.patient.xiugaizhuyuan
              : Strings.patient.yichuhuanzhe}
          </Button>
        </View>
      </View>
    );
...
export const PatientsOutHospitalMenuModal = withStyles(
  MyModalComponent,
  (theme: ThemeType) => {
